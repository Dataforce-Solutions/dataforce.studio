...
interface TrackEventMap {
  ...
  [AnalyticsTrackKeysEnum.run_optimization]: { task: string, teacher_model: string, student_model: string, evaluation_metrics: string }
