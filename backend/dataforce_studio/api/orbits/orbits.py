...
@organization_orbits_router.get("/{orbit_id}", responses=endpoint_responses, response_model=OrbitDetails)
...
@organization_orbits_router.patch("/{orbit_id}", responses=endpoint_responses, response_model=Orbit)
