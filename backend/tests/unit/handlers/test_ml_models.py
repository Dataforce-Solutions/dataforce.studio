...
#     assert result_model == model
#     assert url == "url"
#     mock_get_model.assert_awaited_once_with(model_id)
...
#     mock_get_model.assert_awaited_once_with(model_id)
#     mock_get_orbit_simple.assert_not_called()
...
#     mock_get_orbit_role.return_value = OrbitRole.MEMBER
#
#     msg = "Unable to confirm deletion with status 'MLModelStatus.UPLOADED'"
...
#     mock_get_orbit_role.return_value = OrbitRole.MEMBER
#
#     update_in = MLModelUpdateIn(id=model_id, tags=tags)
...
#     mock_get_orbit_role.return_value = OrbitRole.MEMBER
#
#     update_in = MLModelUpdateIn(id=model_id, tags=["t1"])
#     with pytest.raises(NotFoundError, match="ML model not found"):
#         await handler.update_model(
#             user_id, organization_id, orbit_id, collection_id, model_id, update_in
#         )
#
#     expected_update = MLModelUpdate(id=model_id, tags=["t1"])
#     mock_update.assert_awaited_once_with(
#         model_id,
#         expected_update,
#     )
