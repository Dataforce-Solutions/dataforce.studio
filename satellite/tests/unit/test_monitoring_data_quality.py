...
class TestMonitoringDataQuality:
    ...
    def test_clean_inputs_stay_normal(self) -> None:
    ...
    def test_missing_values_raise_critical_alert(self) -> None:
    ...
    def test_numeric_type_mismatch_warns_within_one_percent(self) -> None:
    ...
    def test_bool_counts_as_numeric_type_mismatch(self) -> None:
    ...
    def test_out_of_range_numeric_raises_critical_alert(self) -> None:
    ...
    def test_range_violation_warns_between_one_and_five_percent(self) -> None:
    ...
    def test_unseen_category_raises_critical_alert(self) -> None:
    ...
    def test_non_string_category_is_type_mismatch_not_unseen(self) -> None:
    ...
    async def test_worker_materializes_data_quality_and_opens_alerts(self) -> None:
        store = InMemoryMonitoringStore()
    ...
    async def test_worker_skips_data_quality_without_profile(self) -> None:
        store = InMemoryMonitoringStore()
    ...
    async def test_data_quality_alert_resolves_when_inputs_recover(self) -> None:
        store = InMemoryMonitoringStore()
    ...
    def test_batched_observations_counted_individually(self) -> None:
    ...
    def test_invalid_values_are_summarized_for_the_detail_panel(self) -> None:
    ...
    def test_unseen_categories_are_named_and_counted(self) -> None:
        ...
        assert result.values["features"]["region"]["invalid"]["type_mismatch"]["types"] == {
            "int": 1
        }

    def test_evidence_lists_stay_bounded(self) -> None:
