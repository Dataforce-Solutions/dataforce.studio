...
class TestTimeoutAlerts:
    def test_a_timeout_is_recognized_by_status_or_gateway_code(self) -> None:
        events = [
            _event(),
            _event("timeout", None),
            _event("error", 504),
    ...
    def test_timeouts_in_consecutive_windows_escalate(self) -> None:
    ...
    def test_an_unrelated_open_alert_does_not_escalate_timeouts(self) -> None:
        events = [_event("timeout", None)]
    ...
    def test_worker_reads_the_upstream_status_code(self) -> None:
    ...
    def test_an_event_without_a_code_still_classifies(self) -> None:
