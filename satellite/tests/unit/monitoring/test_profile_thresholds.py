...
class TestProfileThresholds:
    def test_profile_rule_replaces_the_default(self) -> None:
    ...
    def test_malformed_rules_are_ignored_rather_than_trusted(self) -> None:
        default = Threshold(warning=0.01, critical=0.05)
    ...
    def test_data_quality_uses_the_profile_bounds(self) -> None:
    ...
    def test_feature_drift_uses_the_profile_psi_bounds(self) -> None:
    ...
    def test_runtime_latency_threshold_comes_from_the_deployment(self) -> None:
    ...
    def test_psi_keeps_its_inclusive_warning_band(self) -> None:
    ...
    async def test_alert_says_where_its_threshold_came_from(self) -> None:
        dep = uuid.uuid4()
    ...
    async def test_alert_without_a_profile_rule_says_default(self) -> None:
        dep = uuid.uuid4()
        store = InMemoryMonitoringStore()
        store.add_alert(
            StoredAlert(
